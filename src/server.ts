...
app.use('/images', express.static('public/images')); // Доступ до фотографій білих ведмедів
...
import polarBearRoutes from './routes/polarBears';
app.use('/api/polar-bears', polarBearRoutes);
